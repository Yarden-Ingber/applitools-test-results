    ...
    private void sendEyesEndpointsEvents() throws IOException, MailjetSocketTimeoutException, MailjetException {
        ...
        for (String domainSite : domainsSitesList) {
            ...
            if (! ( domain.contains("***") || site.equals("Itaitest") || site.equals("Yotamdemo") || domain.contains("everfi2eyes.applitools") ||
                    ...
                    domain.contains("oracleeyesapi.applitools") || domain.contains("adidas2eyes.applitools") || domain.contains("nabconnect2eyes.applitools") ||
                    domain.contains("mailchimpeyes.applitools") || site.equals("Eshopworld") || domain.contains("wix2eyes.applitools")) ) {
