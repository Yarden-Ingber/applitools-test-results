...
public class KpisRestCalls {
    ...
    public ResponseEntity state_update(@RequestBody String json) throws IOException, InterruptedException {
        newRequestPrint(json, "/state_update");
        HttpClient client = HttpClient.newHttpClient();
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create(Enums.Strings.NewHerokuApp.value + "/state_update"))
    ...
    public ResponseEntity archive_card(@RequestBody String json) throws IOException, InterruptedException {
        newRequestPrint(json, "/archive_card");
        HttpClient client = HttpClient.newHttpClient();
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create(Enums.Strings.NewHerokuApp.value + "/archive_card"))
                .POST(HttpRequest.BodyPublishers.ofString(json))
                .build();
        HttpResponse<String> response = client.send(request, HttpResponse.BodyHandlers.ofString());
        Logger.info("Response: " + response.statusCode());
